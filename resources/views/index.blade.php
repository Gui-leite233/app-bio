        ...
        <div class="card text-center border-success card-bg-success">
            ...
            <div class="card-body">
                <a href="{{route('site.integrante')}}" class="dropdown-item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" " class="bi bi-people-fill" viewBox="0 0 16 16">
        ...
        <div class="card text-center border-success card-bg-success">
            ...
            <div class="card-body">
                <a href="{{route('site.material')}}" class="dropdown-item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" " class="bi bi-box-fill" viewBox="0 0 16 16">
